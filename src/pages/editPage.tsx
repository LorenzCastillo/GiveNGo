...
export default function DonatePage() {
    ...
    useEffect(() => {
        let userData: IItem[] = [];
        let itemToEdit: IItem = {} as IItem;
        let editIndex: number = 0;
        if (sessionStorage.getItem("editIndex")) {
            editIndex = JSON.parse(sessionStorage.getItem("editIndex") ?? "");
        }
        if (localStorage.getItem("userData")) {
            userData = JSON.parse(localStorage.getItem("userData") ?? "");
        }
        itemToEdit = userData[editIndex];
                                ...
                                <div className="flex flex-col w-full p-4">
                                    ...
                                    <div className="grid grid-rows-1 grid-cols-2">
                                        <div className="grid grid-rows-2 grid-cols-1 col-span-2 lg:col-span-1 lg:mr-2">
                                            <div className="row-span-1 col-span-1">
                                                ...
                                                <input type="text" value={name} onChange={handleNameChange} className="p-2 w-full bg-white text-black border-slate-400" placeholder="" required/>
                                            </div>

                                            <div className="row-span-1 col-span-1">
                                                <label className="select-none text-white">Location</label>
                                                <input type="text" value={location} onChange={handleLocationChange} className="p-2 w-full bg-white text-black border-slate-400" placeholder="" required/>
                                            </div>
                                        ...
                                        <div className="row-span-2 col-span-2 lg:col-span-1 lg:ml-2">
                                            ...
                                            <textarea rows={4} value={description} onChange={handleDescriptionChange} className="p-2 w-full bg-white text-black border-slate-400 resize-none" placeholder="" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-rows-1 grid-cols-2">
                                        <div className="col-span-2 lg:col-span-1 lg:mr-2">
                                            ...
                                            <select onChange={(e) => setCategory(e.target.value)} value={category} className="p-2 w-full bg-white text-black border-slate-400">
                                        ...
                                        <div className="col-span-2 lg:col-span-1 lg:ml-2">
                                            ...
                                            <input type="text" value={contact} onChange={handleContactChange} className="p-2 w-full bg-white text-black border-slate-400" placeholder="" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-rows-1 grid-cols-2">
                                        ...
                                        <div className="relative w-full ml-2 col-span-2 lg:col-span-1 mt-20">
                                            <div className="absolute bottom-0 right-0 mr-2">
                                                <button type="submit" onClick={() => postItem()} className="w-24 px-4 py-2 mt-8 rounded-2xl text-xl text-white bg-gradient-to-r from-custom-post_button_left to-custom-post_button_right">SAVE</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
